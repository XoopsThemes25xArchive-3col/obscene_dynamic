...
downarrowpointer: ["images/arrow-down.png", 14,9], //path to "down arrow" image that gets added to main menu items (last 2 parameters should be width/height of img)
rightarrowpointer: ["images/arrow-right.png", 9,14], //path to "right arrow" image that gets added to LI elements within drop down menu containing additional menus
